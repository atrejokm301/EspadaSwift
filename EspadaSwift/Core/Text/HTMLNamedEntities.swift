// Auto-generated from Python html.entities (+ html5) — full HTML named character references
// Do not hand-edit. Used for e-Sword module text (dictionaries, lexicons, commentaries, Bibles).
// Source: CPython html.entities.name2codepoint + html.entities.html5
import Foundation

enum HTMLNamedEntities {
    /// Full HTML5 named character reference map (name without & and ;).
