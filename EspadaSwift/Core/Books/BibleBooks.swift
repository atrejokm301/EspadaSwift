...
enum BibleBooks {
    ...
    private static let aliasMap: [String: Int] = {
        ...
        let pairs: [([String], Int)] = [
            ...
            (["jueces", "jue", "juec", "jzs", "jdc", "jdg", "judg", "judges", "jgs"], 7),
            (["rut", "rt", "ru", "rth", "ruth"], 8),
            ...
            (["nehemias", "neh", "nee", "nehemiah"], 16),
            (["ester", "est", "esther"], 17),
            (["job", "jb"], 18),
            (["salmos", "salmo", "sal", "slm", "ps", "psa", "psalm", "sl", "psalms", "pslm"], 19),
            (["proverbios", "prov", "pro", "pr", "prv", "proverbs"], 20),
            (["eclesiastes", "ecl", "ec", "qo", "ecls", "ecclesiastes", "ecc", "eccl"], 21),
            (["cantares", "cant", "cnt", "ct", "song", "son", "can", "cantardelos", "sos", "songs", "songofsongs", "canticles"], 22),
            ...
            (["juan", "jn", "jua", "joh", "jhn", "john"], 43),
            (["hechos", "hech", "hch", "act", "acts", "hecho", "ats"], 44),
            ...
            (["efesios", "ef", "eph", "efes", "efe", "efs", "ephesians"], 49),
            ...
            (["santiago", "sant", "stg", "tgo", "jas", "jac", "james", "jam"], 59),
            ...
            (["apocalipsis", "apoc", "apo", "ap", "rev", "revelation", "revel"], 66),
        ]
